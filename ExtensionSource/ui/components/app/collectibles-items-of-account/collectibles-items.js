...
export default function CollectiblesItems({
  ...
  // console.log("[collectibles-items-of-account] selectedAddress = ", selectedAddress, "chainId = ", chainId);
  ...
  const renderCollection = ({
    ...
    return (
      <div className="collectibles-items__collection" key={`collection-${key}`}>
        ...
        {isExpanded ? (
          <Box display={DISPLAY.FLEX} flexWrap={FLEX_WRAP.WRAP} gap={4} justifyContent={JUSTIFY_CONTENT.CENTER} >
