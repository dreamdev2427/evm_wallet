...
export const UPDATE_NATIVE_CURRENCY_USD_RATE = 'UPDATE_NATIVE_CURRENCY_USD_RATE';
export const UPDATE_NET_WORTH_ON_USD = 'UPDATE_NET_WORTH_ON_USD';
export const UPDATE_ERC20_TOKEN_LIST = 'UPDATE_ERC20_TOKEN_LIST';
export const UPDATE_ERC721_TOKEN_LIST = 'UPDATE_ERC721_TOKEN_LIST';
export const DISPLAY_CERTAIN_TOKEN_PRICE = 'DISPLAY_CERTAIN_TOKEN_PRICE';
export const UPDATE_NATIVE_BALANCE = "UPDATE_NATIVE_BALANCE";
export const UPDATE_TOTAL_NETWORTHS = "UPDATE_TOTAL_NETWORTHS";
export const UPDATE_ARE_QUOTES_PRESENT = "UPDATE_ARE_QUOTES_PRESENT";
export const UPDATE_SWAP_TO_TOKEN_VALUE = "UPDATE_SWAP_TO_TOKEN_VALUE";
export const UPDATE_SWAP_TRANSACTION_FEES = "UPDATE_SWAP_TRANSACTION_FEES";
export const UPDATE_ERC721_TOTAL_TOKEN_LIST = "UPDATE_ERC721_TOTAL_TOKEN_LIST";
